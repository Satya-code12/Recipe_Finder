    ...
    <div className=" w-full h-screen flex flex-col " style={{
      ...
      backgroundSize: 'cover',
        ...
        <div className='my-auto'>
          <div className='text-white flex flex-col justify-center w-[60%] h-[20rem] px-4 text-justify mx-auto gap-8 backdrop-filter backdrop-blur-[50px] bg-opacity-10 rounded-3xl border'>
            <h1 className="text-[32px] font-bold " style={{
              letterSpacing: "1px",
            ...
            <button className='bg-white text-black font-medium rounded-lg w-36 flex gap-3 justify-center items-center h-10' onClick={()=>setShowModal(true)}>
